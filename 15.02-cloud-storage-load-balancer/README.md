...
Ссылку на тестовую картинку я получил из веб-консоли YC, и уже позже добавил в скрипт и применил изменения в терраформе. Как получить эту ссылку в виде переменной - не разобрался. 
