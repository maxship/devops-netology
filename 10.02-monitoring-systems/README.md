...
#### Push
**Плюсы**
- Настройка на агентах какие, куда и когда передавать данные.
...
Разобрался как добавлять разные типы графиков в панель, а как изменить единицы измерения, не пойму.
    
 ![1024](https://user-images.githubusercontent.com/72273610/151395243-df984850-9800-4069-86dd-6ab40dfda92f.png)
