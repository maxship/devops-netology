...
Не уверен, но теоретически, количество соединений клиент-сервер будет равно количеству портов `2^16 - 1024 = 65536 - 1024 = 64512`, где `1024` - количество зарезервированных системой портов. В случае, если клиентов больше одного, то `64512 * количество подключенных IP`.
