...
_- Требуется наиболее производительное бесплатное opensource решение для виртуализации небольшой (20 серверов) инфраструктуры Linux и Windows виртуальных машин._  Для этой задачи подойдет Zen. Это надежное и производительное решение, хотя гостевые ОС на Windows будут работать медленнее.

_- Необходимо бесплатное, максимально совместимое и производительное решение для виртуализации Windows инфраструктуры._ Для этих условий из opensource систем лучше подойдет KVM, т.к. у него очень хорошая аппаратная совместимость и производительность, в том числе с гостевыми ОС на Windows. Кроме этого, возможен вариант с Hyper-V Server. Это бесплатное решение, обеспечивающее полную совместимость с Windows инфраструктурой, но, требующее лицензирования всех виртуальных машин.
